<?php
	...
	array_push($version_specifics, array("S*access_token", "S*username", "B*sync", "S*expires_in", "S*created_at", "S*refresh_token", "Stheme", "Scolors", "Bshow-custom-profiles", "Bhide-broadcasts", "Bhide-goals", "Bclustermap", "Scustom-banner-url", "Scustom-banner-pos", "Slink-github", "Bcodam-monit", "Bcodam-auto-equip-coa-title"));
	array_push($version_defaults, array(null, null, true, null, null, null, "system", "default", true, false, false, true, "", "center-center", "", true, false));
