<?php
	...
	function access_token_accepted($accessToken) {
		if (!file_exists("db/tokens.json")) {
			return (false);
		}
	...
	function save_access_token($auth) {
		...
		array_push($tokensDB, $hashedToken);
		if (file_put_contents("db/tokens.json", json_encode($tokensDB, JSON_UNESCAPED_UNICODE)) !== false) {
			return (true);
		}
		return (false);
	}
